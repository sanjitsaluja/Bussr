...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', #'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'bussr',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'dudy',                  # Not used with sqlite3.
